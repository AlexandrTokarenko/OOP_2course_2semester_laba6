...
public class Menu {
    public void show() {
        ...
        System.out.println("3. Зчитати дані потягів з бінарного файлу");
        System.out.println("4. Записати дані потягів в бінарний файл");
        System.out.println("5. Додати елемент в кінець масиву");
        System.out.println("6. Видалити останній елемент масиву");
